...
// let ru = arr = ['пн', 'вт', 'ср', 'чт', 'пт', 'сб', 'вс'];
// let en = arr = ['mn', 'ts', 'wd', 'th', 'fr', 'st', 'sn'];
// let lang = en;
// if (lang === ru){
//     console.log(ru);
// }
...
// }
// else if(num => 3) {
//     console.log('трехзначное и более положительное')
// }
...
// let red, yellow = prompt("Горит красный или желтый сигнал светофора?");
// if (red, yellow === 'нет') {
